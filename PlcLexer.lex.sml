...
{fin = [(N 21),(N 66)], trans = 12},
{fin = [(N 62)], trans = 0},
{fin = [(N 31),(N 66)], trans = 14},
{fin = [(N 34)], trans = 0},
{fin = [(N 14),(N 66)], trans = 0},
{fin = [(N 16),(N 66)], trans = 17},
{fin = [(N 19)], trans = 0},
{fin = [(N 7),(N 66)], trans = 19},
{fin = [(N 7)], trans = 19},
{fin = [(N 42),(N 66)], trans = 0},
{fin = [(N 38),(N 66)], trans = 22},
{fin = [(N 59)], trans = 0},
...
| 12 => (COMMA(yypos, yypos))
| 14 => (SEMIC(yypos, yypos))
| 16 => (COLON(yypos, yypos))
| 19 => (DCOLON(yypos, yypos))
| 21 => (EQ(yypos, yypos))
| 24 => (NEQ(yypos, yypos))
| 26 => (NOT(yypos, yypos))
| 29 => (AND(yypos, yypos))
...
| 34 => (LTE(yypos, yypos))
| 36 => (PLUS(yypos, yypos))
| 38 => (MINUS(yypos, yypos))
| 4 => (lex())
| 40 => (MULTI(yypos, yypos))
| 42 => (DIV(yypos, yypos))
| 44 => (LBRA(yypos, yypos))
| 46 => (RBRA(yypos, yypos))
| 48 => (LKEY(yypos, yypos))
